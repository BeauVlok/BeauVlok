        ...
        <Grid container stackable verticalAlign="middle">
          <Grid.Row>
            ...
            <p>
              ...
              blijven mee ontwikkelen in de nieuwe kennis van de gezondheidszorg
              en dus blijven leren om deze kennis te beheersen. Misschien nog
              wel belangrijker om juist te ontwikkelen in het verpleegkundig
              beroep na het behalen van je diploma!
            </p>
            <p>
              ...
              verwachting zal dit de komende jaren nog veel van toepassing zijn.
              Een mooi voorbeeld van een verandering is; vroeger lag de zorg bij
              de ziekte van een patiënt, nu ligt de zorg voornamelijk bij het
              leren omgaan met de ziekte. Tijdens de opleiding wordt er al veel
              aandacht besteedt aan persoonsgerichte zorg, namelijk de zorg die
              is afgestemd op iemands leven, wensen en behoeften. Hierbij speelt
              eigen regie een belangrijke rol in deze tijd en de toekomst. De
              verpleegkundige gaat samen met de patiënt op zoek naar de juiste
              zorg en ondersteuning (Kennisplein Zorg voor Beter, 2020).
            </p>
            ...
            <p>
              ...
              hiervoor te certificeren. Het doel van de wet BIG is om ervoor te
              zorgen dat kwaliteit in de gezondheidszorg behouden wordt en
