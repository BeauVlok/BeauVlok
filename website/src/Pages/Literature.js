 ...
 Literatuur
    ...
    <List.Item>
      ...
      <List.Content>
        ...
        <List.Description>
          Kennisplein Zorg voor Beter. (2020, 13 februari). Persoonsgerichte zorg. 
          Geraadpleegd op 17 maart
          	2020, van https://www.zorgvoorbeter.nl/persoonsgerichte-zorg
        </List.Description>
      </List.Content>
    </List.Item>
    <List.Item>
      ...
      <List.Content>
        ...
        <List.Description>
        Lambregts, J., Grotendorst, A., & van Merwijk, C. (2016). Bachelor of Nursing 2020: Een
        Toekomstbestendig Opleidingsprofiel. Houten: Bohn Stafleu van Loghum.
        	https://www.venvn.nl/Portals/1/Nieuws/Ouder%20dan%202010/3_profiel%20verpleegkund	ige_def.pdf
        </List.Description>
      </List.Content>
    </List.Item>
    <List.Item>
      ...
      <List.Content>
        ...
        <List.Description>
        Ministerie van Volksgezondheid, Welzijn en Sport. (2020, 1 januari). 
        Wet zorg en dwang (Wzd).
        Geraadpleegd op 18 maart 2020, van https://www.dwangindezorg.nl/wzd 
        </List.Description>
      </List.Content>
    </List.Item>
    <List.Item>
      ...
      <List.Content>
        ...
        <List.Description>
        Ministerie van Volksgezondheid, Welzijn en Sport. (2020, 6 januari). 
        Wet- en regelgeving.
        Geraadpleegd op 18 maart 2020, van https://www.bigregister.nl/registratie/nederlands-	diploma-registreren/wet--en-regelgeving
        </List.Description>
      </List.Content>
    </List.Item>
    <List.Item>
      ...
      <List.Content>
        ...
        Geraadpleegd op 17 maart 2020, van https://www.vtv2018.nl/belangrijkste-ontwikkelingen
        </List.Description>
      </List.Content>
    </List.Item>
  </List>
