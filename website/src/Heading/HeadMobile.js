    ...
    render() {
     ...
     <Image id="mainImageMobile"src={beau} centered/>
                <div id="maincard"centered>
                    ...
                    <h1 class="mainTitleMobile"> Ervaren. Empathisch. <br/>Toekomstig Verpleegkundige.</h1>
                    <p id="mainparMobile">Mijn naam is Beau Vlok, 20 jaar en derdejaars hbo-verpleegkunde student aan de Hogeschool Rotterdam. Ik ben een leergierige student, heb veel doorzettingsvermogen en ik werk gedisciplineerd. 
